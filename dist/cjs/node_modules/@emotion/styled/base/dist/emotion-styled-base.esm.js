...
var emotionElement3838ba9e_esm = require('../../../react/dist/emotion-element-3838ba9e.esm.js');
var index = require('../../../../../_virtual/index.js');

var testOmitPropsOnStringTag = emotionIsPropValid_esm;
...
var createStyled = function createStyled(tag, options) {
  ...
  return function () {
    ...
    var Styled = emotionElement3838ba9e_esm.w(function (props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = index.react.exports.useContext(emotionElement3838ba9e_esm.T);
      }

      if (typeof props.className === 'string') {
        className = emotionUtils_esm.getRegisteredStyles(cache.registered, classInterpolations, props.className);
      ...
      }), /*#__PURE__*/index.react.exports.createElement(FinalTag, newProps));
    });
