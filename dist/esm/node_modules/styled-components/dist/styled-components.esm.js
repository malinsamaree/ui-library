import { __spreadArray, __assign, __rest } from '../../tslib/tslib.es6.js';
import React from '../../react/index.js';
import unitlessKeys from '../../@emotion/unitless/dist/unitless.esm.js';
import { prefixer, middleware } from '../../stylis/src/Middleware.js';
import { stringify } from '../../stylis/src/Serializer.js';
...
function useStyleSheet() {
    return react.exports.useContext(StyleSheetContext) || mainSheet;
}
function useStylis() {
    return react.exports.useContext(StylisContext) || mainStylis;
}
...
function useInjectedStyle(componentStyle, isStatic, resolvedAttrs, warnTooManyClasses) {
    ...
    // eslint-disable-next-line react-hooks/rules-of-hooks
    if (process.env.NODE_ENV !== 'production')
        react.exports.useDebugValue(className);
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef, isStatic) {
    ...
    // eslint-disable-next-line react-hooks/rules-of-hooks
    if (process.env.NODE_ENV !== 'production')
        react.exports.useDebugValue(styledComponentId);
    // NOTE: the non-hooks version only subscribes to this when !componentStyle.isStatic,
    // but that'd be against the rules-of-hooks. We could be naughty and do it anyway as it
    // should be an immutable value, but behave for now.
    var theme = determineTheme(props, react.exports.useContext(ThemeContext), defaultProps) || EMPTY_OBJECT;
...
export { StyleSheetContext, ThemeContext, css, styled as default, isStyledComponent, SC_VERSION as version };
